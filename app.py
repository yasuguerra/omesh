...
app.title = "Omesh Dashboard"

# --- Lógica de inicialización (ej. fechas para el DatePicker) ---
START_DATE_GLOBAL = '2021-01-01'
...
app.layout = dbc.Container([
    dbc.Row([
        ...
        dbc.Col(html.H1('Omesh Dashboard – AI Insights', style={'textAlign': 'center', 'color': '#002859', 'fontWeight': 'bold', 'paddingTop': '20px'}), width=True),
